...
@onready var lbl_required_num: Label = $Canvas/Margin_Goal/Pnl_Results/Margin_Panel/VBox_Results/HBoxContainer/Lbl_Required_Num
@onready var lbl_total_num: Label = $Canvas/Margin_Goal/Pnl_Results/Margin_Panel/VBox_Results/HBoxContainer4/Lbl_Total_Num
@onready var bttn_next: Button = $Canvas/Margin_Goal/Pnl_Results/Margin_Panel/VBox_Results/Bttn_Next
